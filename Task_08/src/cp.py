...
class SearchWindow(QMainWindow):
    def __init__(self):
        ...
        search_button.clicked.connect(self.searchpokemon)
        ...
        capture_button.clicked.connect(self.capturepokemon)
    ...
    def capturepokemon(self):
        if self.captured_pokemon_pixmap:
            ...
            msg_box = QMessageBox()
            custom_icon = QIcon("pokeball-logo-DC23868CA1-seeklogo.com.png")
